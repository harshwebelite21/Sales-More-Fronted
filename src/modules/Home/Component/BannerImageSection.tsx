...
export const BannerImageSection = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 p-16 justify-items-center relative -z-10">
      <div className="flex flex-col gap-5 justify-center  items-center text-center md:text-left md:items-start">
        <h3 className="text-[#5138ee] text-2xl">WELCOME TO</h3>
        <h1 className="text-5xl font-bold">Sales More</h1>
